    ...
    return <div className="categorysub" >
        ...
        <div>
            ...
            <div className="at-events">
                <div className="column-at"> <img src={place.ImageUrl} alt="sdfsdf" className="billede1" /> <h4 className="overskrifter1">{place.Name}</h4> <p className="lorem-tekst">Lorem ipsum dolor sit amet, consectetur adipiscing eli</p>
